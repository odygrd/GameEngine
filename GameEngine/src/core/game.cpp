...
Game::Game()
{
	...
	m_pLights[0] = PointLight(vec3(-1, -2.0, 0), vec3(0.8f, 0.2f, 0.0f), 0.8f);
	m_pLights[1] =  PointLight(vec3(1, -2.0, 0), vec3(0.0f, 0.5f, 0.9f), 0.8f);
	m_pLights[2] = PointLight(vec3(0, -1.5, -3.0), vec3(0.0f, 0.9f, 0.2f), 0.85f);
